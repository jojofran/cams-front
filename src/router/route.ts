...
export const dynamicRoutes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
                ...
                children: [
                    {
                        path: '/viewList/view1',
                        name: 'view1',
                        component: () => import('/@/views/cams/view1/index.vue'),
                        meta: {
                            title: 'message.router.view1',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                    ...
                    },
                    {
                        ...
                        name: 'detail',
                        component: () => import('/@/views/cams/view1/detail.vue'),
                        meta: {
                    ...
                    {
                        path: '/viewList/dataSync',
                        name: 'dataSync',
                        component: () => import('/@/views/cams/dataSync/index.vue'),
                        meta: {
                            title: 'message.router.dataSync',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                ...
                children: [
                    {
                        path: '/lab/dicType',
                        name: 'section',
                        component: () => import('/@/views/cams/dicType/index.vue'),
                        meta: {
                            title: 'message.router.dicType',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                    ...
                    },
                    {
                        path: '/lab/sysVendor',
                        name: 'sysVendor',
                        component: () => import('/@/views/cams/sysVendor/index.vue'),
                        meta: {
                            title: 'message.router.sysVendor',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                    ...
                    {
                        path: '/lab/dictionaryLis',
                        name: 'dictionaryLis',
                        component: () => import('/@/views/cams/dictionary/lisIndex.vue'),
                        meta: {
                            title: 'message.router.dictionaryLis',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                    ...
                    },
                    {
                        path: '/lab/dictionary',
                        name: 'dictionary',
                        component: () => import('/@/views/cams/dictionary/carssIndex.vue'),
                        meta: {
                            title: 'message.router.dictionary',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                    ...
                    {
                        path: '/lab/mapperIndex',
                        name: 'mapperIndex',
                        component: () => import('/@/views/cams/mapper/index.vue'),
                        meta: {
                            title: 'message.router.mapperList',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,
                    ...
                    },
                    {
                        path: '/lab/mapper',
                        name: 'mapper',
                        component: () => import('/@/views/cams/mapper/mapper.vue'),
                        meta: {
                            title: 'message.router.mapper',
                            isLink: '',
                            isHide: true,
                            isKeepAlive: true,
                            isAffix: false,
            ...
            },
            {
                ...
                children: [
                    {
                        path: '/system/dbConfig',
                        name: 'system',
                        component: () => import('/@/views/cams/dbConfig/index.vue'),
                        meta: {
                            title: 'message.router.dbConfig',
                            isLink: '',
                            isHide: false,
                            isKeepAlive: true,
                            isAffix: false,

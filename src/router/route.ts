...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			},
			{
				path: '/lis', // lis数据源
				name: 'lis',
				component: () => import('/@/views/cams/dataSource/index.vue'),
				redirect: '/lis/dataSource',
				meta: {
					title: 'message.router.lisDataSource',
					isLink: '',
					isHide: false,
					isKeepAlive: true,
					isAffix: true,
				...
				children: [
					...
					},
					{
						path: '/lis/dataView',
						name: 'view',
						component: () => import('/@/views/cams/dataView/index.vue'),
						meta: {
							title: 'message.router.dataView',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
			...
			},
			{
				path: '/viewList', // 视图浏览
				name: 'viewList',
				component: () => import('/@/views/cams/basicInformation/index.vue'),
				redirect: '/lab/basic',
				meta: {
			...
			},
			{
				...
				children: [
					...
					// 	path: '/lab/section',
					// 	name: 'section',
					// 	component: () => import('/@/views/cams/section/index.vue'),
					// 	meta: {
					// 		title: 'message.router.section',
					// 		isLink: '',
					// 		isHide: false,
					// 		isKeepAlive: true,
					// 		isAffix: false,
					...
					},
					{
						path: '/lab/mapper',
						name: 'mapper',
						// component: () => import('/@/views/cams/dictionary/mapper.vue'),

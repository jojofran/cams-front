<template>
	<div>
		...
		<el-card shadow="hover" style="margin-top: 2px; height: 700px; width: 100%">
			<div style="width: 100%; float: left">
				<el-descriptions class="margin-top" :column="6" :border="true">
			...
			<div style="margin-top:20px;width:50%;float:left;border:1px dashed lightgray;padding:20px;">
			...
			<div style="margin-top:20px;width:48%;float:left;border:1px dashed lightgray;margin-left:30px;padding:20px;">
